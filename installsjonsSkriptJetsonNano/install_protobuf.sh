...
echo "** Download protobuf-3.17.3 sources"
cd $folder
if [ ! -f protobuf-python-3.17.3.zip ]; then
  wget https://github.com/protocolbuffers/protobuf/releases/download/v3.17.3/protobuf-python-3.17.3.zip
fi
if [ ! -f protoc-3.17.3-linux-aarch_64.zip ]; then
...
unzip protoc-3.17.3-linux-aarch_64.zip -d protoc-3.17.3
sudo cp protoc-3.17.3/bin/protoc /usr/local/bin/protoc

echo "** Build and install protobuf-3.17.3 libraries"
...
echo "** Build protobuf-3.17.3 successfully"
